...
//        calculate the total ones in the array
        int totalOnes = 0;
        for(int num : nums)
            totalOnes += num;
//        initialize the count of ones in the current window
        int onesCount = nums[0], end = 0;
//        slide the window across the array
        for(int start = 0 ; start < nums.length ; start++) {
//        adjust the onesCount by removing the element that is sliding out of the window
            if(start != 0)
